"""HTML output — generates a self-contained, shareable news digest page."""
import html
...
class HTMLFormatter:
    def format(self, articles: List[Article]) -> str:
        ...
        for i, a in enumerate(articles, 1):
            ts = html.escape(a.timestamp.strftime("%Y-%m-%d %H:%M UTC")) if a.timestamp else "—"
...
<title>Clawler News Digest — {len(articles)} stories</title>
<style>
